  ...
  return (
    <div className=" min-w-full container">
      ...
      <div className="px-8 py-4">
        <p className='text-xs font-Poppins font-extrabold leading-4 tracking-wide mb-20'>
          ...
          perfeccionista).⁣ Me encantei mais ainda com a possibilidade de uma
          ...
          especial para os nossos filhos. Assim surgiu o carro chefe da Joanita
        </p>
      </div>
    </div>
  );
